...
const about = [
    ...
    {title:"NOS ENGAGEMENTS ET NOTRE VISION", text:"Pour nos clients, nous nous engageons à répondre aux  exigences actuelles des industries et des collectivités pour anticiper les défis futurs.   TEKALP accompagne ses clients et partenaires avant, pendant et après l’intégration de  ses solutions.  Avec nos partenaires, nous faisons progresser l’innovation et  nos solutions avec des données concrètes issues du terrain.  Notre métier est de faire le  lien entre concepteurs et utilisateurs."},
]
